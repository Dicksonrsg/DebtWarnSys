...
urlpatterns = [
    ...
    path(
        "delete_company/<int:primary_key>", views.delete_company, name="delete_company"
    ),
    path("add_company/", views.add_company, name="add_company"),
    path(
        "update_company/<int:primary_key>", views.update_company, name="update_company"
    ),
    # Debtor
    ...
    path(
        ...
        views.company_user_register,
        name="company_user",
    ),
    path(
        "update_company_user/<int:primary_key>",
        views.update_company_user,
