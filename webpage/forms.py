...
class SignUpForm(UserCreationForm):
    ...
    first_name = forms.CharField(label="", max_length=140, widget=forms.TextInput(attrs={'class':'form-control', 'placeholder':'First Name'}))
    last_name = forms.CharField(label="", max_length=210, widget=forms.TextInput(attrs={'class':'form-control', 'placeholder':'Last Name'}))
...
class AddressForm(forms.ModelForm):
    ...
    class Meta:
        model = Address
        fields = ('cep', 'street', 'number', 'neighbourhood', 'state', 'country', 'details')        
